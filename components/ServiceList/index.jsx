  ...
  const serviceData = services || [
    {
      ...
      imageUrl: "/images/web_development.png",
      href: "/service/web",
    },
    {
    ...
    imageUrl: "/images/graphics_design.png",
    href: "/service/graphics_design",
  },
    {
      title: "Digital marketing",
      imageUrl: "/images/digital_marketing.png",
      href: "/service/digital_marketing",
    },
    {
      title: "Branding",
      imageUrl: "/images/brand_development.jpg",
          ...
          <Link href={item.href} className="cs-iconbox cs-style3">
            <>
              ...
              <Div className="cs-iconbox_in">
                ...
                <Div className="cs-iconbox_description">{item.description}</Div>
              </Div>
            </>
          </Link>
        </Div>
