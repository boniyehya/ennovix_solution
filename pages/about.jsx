          ...
          <Div className="row">
            <Div className="col-xl-5 col-lg-7">
              ...
              >
                <Spacing lg="30" md="20" />
                <p className="cs-m0">
                "Welcome to Ennovix", your trusted partner in technology solutions.<br/>
                 At Ennovix, we are passionate about leveraging cutting-edge technologies 
                 to drive digital transformation and empower businesses to thrive in 
                 today's fast-paced world.<br/>
                 As a technology company, we offer a comprehensive range of
                 services to meet the diverse needs of our clients. From web and app
                 development to graphics design, UI/UX development, branding, network
                 installation, and digital marketing, our talented team of experts is
                 dedicated to delivering innovative solutions that exceed expectations. <br/>
                 With a focus on user-centric design and state-of-the-art technology, we
                 create seamless digital experiences that captivate your audience and
                 drive engagement. Our team of skilled developers, designers, and
